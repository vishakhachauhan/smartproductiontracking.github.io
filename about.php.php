      ...
      <!-- Main -->
        <div id="main">
          <div class="inner">
            ...
            <header id="header">
              <div class="logo">
                <a href="userhomepage.php">Hi, User</a>
              </div>
            </header>
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <p><strong>Hello</strong> abc </p>
                  </div>
                </div>
              </div>
            </div>

            <iframe width="100%" height="500px" frameborder="0" scrolling="no" src="https://onedrive.live.com/embed?resid=CBF98D68B799B967%21133&authkey=%21AOjtJJufTOGLFE4&em=2&wdAllowInteractivity=False&wdHideGridlines=True&wdHideHeaders=True&wdDownloadButton=True&wdInConfigurator=True"></iframe>
        ...
        <div id="sidebar">
          ...
          <div class="inner">   
            ...
            <footer id="footer">
              ...
              <br> <a rel="nofollow" href="https://www.abfrl.com">Website</a> </br> </p>
            </footer>
